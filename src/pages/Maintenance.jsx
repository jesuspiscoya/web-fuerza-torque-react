...
export const Maintenance = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="h-[25rem] bg-[url('../assets/mantenimiento.jpg')] bg-no-repeat bg-cover">
        ...
        <div className="container flex gap-14">
          <div className="flex flex-col gap-5 w-1/2">
            ...
            <p className="text-gray-300">
              ...
              lo que se ofrece actualmente, es un servicio técnico integral que
              tiene como principales objetivos la orientación al cliente, con
              atención personaliza y profesional.
            </p>
          </div>
          <Carousel
          ...
          >
            {images.map((item, index) => (
              <div key={index} className="relative">
                <img src={item.img} className="h-96 object-cover" />
              </div>
            ))}
          </Carousel>
        </div>
        ...
        <div className="container text-center flex flex-col gap-10">
          ...
          <div className="grid grid-cols-3 gap-5">
            {[...images, ...images].map((item, index) => (
              <div key={index} className="relative">
                <img src={item.img} className="h-80 object-cover" />
