  ...
  return (
    <>
      <div className="">
        <Slider />
        <Navbar />
        <div className="flex flex-col md:flex-row min-h-screen items-center gap-10 md:gap-20 bg-gradient-to-t from-gray-900 to-blue-gray-900 px-10 md:px-24 py-7">
          ...
          <img
            src={img1}
            alt="Sobre nosotros"
            className="w-full h-1/2 ring-2 ring-blue-gray-200 rounded-xl shadow-lg md:shadow-2xl shadow-yellow-700 md:shadow-yellow-700 object-cover mb-4 md:mb-0"
          />
        </div>
        <div className="relative flex min-h-screen md:overflow-hidden">
          <div className="parallax-bg" />
          <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col gap-8 py-7 md:flex-row md:gap-0 text-center items-center bg-black/75">
            <h1 className="caveat-700 text-5xl md:text-8xl text-white px-20 md:w-1/2">
              ¿Qué hacemos?
            </h1>
            <div className="md:w-1/2 text-center px-10 md:px-14 h-full flex flex-col justify-center md:bg-black rounded-l-3xl md:ring-1 md:shadow-2xl md:shadow-black">
              <h1 className="text-xl md:text-2xl font-bold text-yellow-700">
                SOLUCIONES
              </h1>
              <div className="h-0.5 bg-red-600 w-28 mx-auto mt-1 mb-5"></div>
              ...
              <div className="flex flex-col md:flex-row mt-10 md:mt-16 gap-7 sm:gap-10">
                <div className="rounded-2xl shadow-lg shadow-blue-gray-700 bg-blue-gray-900 border-2 border-yellow-300 p-6 md:py-10 md:px-6 hover:scale-105 duration-500 hover:shadow-md">
                  <i className="fa-solid fa-medal fa-2xl text-red-700"></i>
        ...
        <div className="relative bg-blue-gray-900 overflow-hidden py-14 md:py-28">
          <div className="parallax-bg-2" />
          <div className="relative h-full bg-black/70 text-yellow-50 w-full flex flex-col gap-7 md:px-32 py-14">
            <div className="flex flex-col items-center text-center md:items-start">
              <h1 className="text-xl md:text-2xl font-bold text-yellow-700">
                NUESTRAS MARCAS
              </h1>
              <div className="h-0.5 bg-red-600 w-40 md:w-48 mt-1 mb-5"></div>
            </div>
            <Carousel />
          </div>
        </div>
